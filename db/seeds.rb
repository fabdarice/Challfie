...
if Book.count == 0
	...
	newbie_three_book.challenges.create(point: 120, description_en: 'Take a selfie on a plane', description_fr: 'Prendre un selfie dans un avion', difficulty: 3)
	...
	apprentice_three_book.challenges.create(point: 210, description_en: 'Take a selfie while camping', description_fr: 'Prendre un selfie en faisant du camping', difficulty: 3)
